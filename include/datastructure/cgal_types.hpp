...
inline boost::multiprecision::mpq_rational convertRation(mpq_class& p)
{
	//return boost::multiprecision::mpq_rational(p.get_num().get_d(), p.get_den().get_d());
	return boost::multiprecision::mpq_rational(p.__get_mp());
}
