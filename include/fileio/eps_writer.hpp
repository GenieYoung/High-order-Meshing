...
class EPSWriter
{
  public:
    ...
    Color colorCurves = {0.0, 0.5, 0.5};
    Color colorEdges = {0.6, 0.6, 0.6};
    Color colorSubcurves = {0.85, 0.85, 0.85};
    Color colorConic = { 1.0,0.0,0.0 };
    Color colorVertices = {0.0, 0.0, 0.0};
    Color colorCtrlpts = {0.7, 0.7, 0.7};
  ...
  private:
     ...
     */
    void writeCurve(std::ostream& out, const vector<Vec2<double>>& ctrlpts, const vector<double>& weights) const;
